 ...
 *}
{strip}
{translate|assign:"pageTitleTranslated" key="submission.page.history" id=$proposalId}
...
<a href="{url op="submissionEventLog" path=$articleId}" class="action">{translate key="submission.history.viewLog"}</a>{if $isEditor} |
<a href="{url op="clearSubmissionEventLog" path=$articleId}" class="action" onclick="return confirm('{translate|escape:"jsparam" key="submission.event.confirmClearLog"}')">{translate key="submission.history.clearLog"}</a>{/if}
</div>
<br /><br />
...
<a class="action" href="{url op="submissionEmailLog" path=$articleId}">{translate key="submission.history.viewLog"}</a>{if $isEditor} |
<a class="action" href="{url op="clearsubmissionEmailLog" path=$articleId}" onclick="return confirm('{translate|escape:"jsparam" key="submission.email.confirmClearLog"}')">{translate key="submission.history.clearLog"}</a>{/if}
</div>
<br /><br />
...
<a class="action" href="{url op="submissionNotes" path=$articleId}">{translate key="submission.notes.viewNotes"}</a> |
