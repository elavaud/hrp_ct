 ...
 *
 * Step 9 of author article submission.
 *
 * $Id$
 *}
{assign var="pageTitle" value="author.submit.step9"}
...
<form method="post" action="{url op="saveSubmit" path=$submitStep}">
    ...
    <h4>{translate key="author.submit.step2"}&nbsp;&nbsp;&nbsp;<a href="{url op="submit" path="2" articleId=$article->getId()}"><i>{translate key="common.modify"}</i></a></h4>
    <br />
    {include file="submission/metadata/articleDetails.tpl"}
    
    <div class="separator"></div>
    
    <h4>{translate key="author.submit.step3"}&nbsp;&nbsp;&nbsp;<a href="{url op="submit" path="3" articleId=$article->getId()}"><i>{translate key="common.modify"}</i></a></h4>
    <br />
    {include file="submission/metadata/articleDrugs.tpl"}

    <div class="separator"></div>
    
    <h4>{translate key="author.submit.step4"}&nbsp;&nbsp;&nbsp;<a href="{url op="submit" path="4" articleId=$article->getId()}"><i>{translate key="common.modify"}</i></a></h4>
    <br />
    ...
    {call_hook name="Templates::Author::Submit::Step9::AdditionalItems"}
