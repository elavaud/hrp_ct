...
/**
 * @file classes/author/form/submit/AuthorSubmitStep7Form.inc.php
 *
 * Copyright (c) 2003-2011 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class AuthorSubmitStep7Form
 * @ingroup author_form_submit
 *
 * @brief Form for Step 7 of author article submission.
 */
...
class AuthorSubmitStep7Form extends AuthorSubmitForm {

	/**
	 * Constructor.
	 */
	function AuthorSubmitStep7Form(&$article, &$journal) {
		parent::AuthorSubmitForm($article, 7, $journal);
